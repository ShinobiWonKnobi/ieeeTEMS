...
export const values = [
  {
    ...
    color: "primary", // Used for styling, corresponds to Tailwind colors
    icon: "M13 10V3L4 14h7v7l9-11h-7z" // SVG path data (example)
  },
  {
    id: 2,
    title: "Collaboration",
  ...
  },
  {
    ...
    color: "primary", // Can reuse colors
...
// Helper component to render SVG icons from path data (optional)
// You might have a better Icon component system already
// export const IconRenderer = ({ pathData, className = "w-8 h-8" }) => (
