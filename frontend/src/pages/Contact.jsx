...
const Contact = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-heading mb-8">Contact Us</h1>
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">info@ieeetems.org</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">SRM Institute of Science and Technology<br />Kattankulathur, Chennai</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Meeting Hours</h3>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-primary text-white p-3 rounded-full hover:bg-blue-700 transition">
